...
{
    [CustomEditor(typeof(SOAssetPack))]
    class AssetPackEditor : UnityEditor.Editor
    {
        ...
        void OnEnable()
        {
            //m_SceneAssetProperty = serializedObject.FindProperty("m_SceneAsset");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                var assetPack = (SOAssetPack)target;
        ...
        void DrawAsset(string guid, SOAssetPack.Asset asset)
        {
