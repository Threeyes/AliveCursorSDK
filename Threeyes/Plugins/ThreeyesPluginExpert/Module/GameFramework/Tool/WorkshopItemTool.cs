...
namespace Threeyes.GameFramework
{
    ...
    public static class WorkshopItemInfoExtension
    {
        ...
        public static string PersistentDataDirPath(this WorkshopItemInfo workshopItemInfo)
        {
            ...
            return GameFramework_PathDefinition.Data_Save_ItemDirPath + "/" + workshopItemInfo.DirName() + "/" + GameFramework_PathDefinition.persistentFolderName;
        }
        ...
        {
            //PS:相对其文件夹进行存储，避免使用id生成，因为调试时未上传的Mod的id无效
            return GameFramework_PathDefinition.Data_Save_ItemLocalDirPath + "/" + workshopItemInfo.DirName() + "/" + GameFramework_PathDefinition.persistentFolderName;
        }
        public static string LogDirPath(this WorkshopItemInfo workshopItemInfo)
        {
            return GameFramework_PathDefinition.Data_Save_LogDirPath + "/" + workshopItemInfo.DirName();
