...
namespace Threeyes.GameFramework
{
    ...
    public abstract class SOWorkshopItemInfo : ScriptableObject
    {
        ...
        public static string GetItemDirPath(string itemName) { return GameFramework_PathDefinition.ItemParentDirPath + "/" + itemName; }
        public static string GetRelatedItemDirPath(string itemName) { return $"Assets/{GameFramework_PathDefinition.ItemRootDirName}/{itemName}"; }
        ...
        where TItemInfo : WorkshopItemInfo, new()
    {
        ...
        ///——ItemInfo.json
        ///——Preview.xxx
        public override string ExportItemDirPath { get { return GameFramework_PathDefinition.ExportItemRootDirPath + "/" + itemName; } }
