...
namespace Threeyes.Steamworks
{
    ...
    public static class Steamworks_EditorDefinition
    {
        ...
        //##
        public const string MenuElement_Cursor = "Cursor/";//ToDelete(或改名为Mod)
        ...
        public const string HierarchyMenuPrefix_Cursor_Controller_Environment = Hierarchy_GameObject + ComponentMenuPrefix_Root_Cursor_Controller_Environment;
        public const string HierarchyMenuPrefix_Cursor_Controller_PostProcessing = Hierarchy_GameObject + ComponentMenuPrefix_Root_Cursor_Controller_PostProcessing;
        public const string HierarchyMenuPrefix_Cursor_Controller_State = Hierarchy_GameObject + ComponentMenuPrefix_Root_Cursor_Controller_State;
        public const string HierarchyMenuPrefix_Cursor_Controller_Transform = Hierarchy_GameObject + ComponentMenuPrefix_Root_Cursor_Controller_Transform;
        public const string HierarchyMenuPrefix_Cursor_Controller_Transform_BoredAction = Hierarchy_GameObject + ComponentMenuPrefix_Root_Cursor_Controller_Transform_BoredAction;
        public const string HierarchyMenuPrefix_Cursor_Behaviour_Setting = Hierarchy_GameObject + ComponentMenuPrefix_Root_Cursor_Behaviour_Setting;
        public const string HierarchyMenuPrefix_Cursor_Behaviour_Input = Hierarchy_GameObject + ComponentMenuPrefix_Root_Cursor_Behaviour_Input;
        public const string HierarchyMenuPrefix_Cursor_Behaviour_Appearance = Hierarchy_GameObject + ComponentMenuPrefix_Root_Cursor_Behaviour_Appearance;
        public const string HierarchyMenuPrefix_Cursor_Behaviour_State = Hierarchy_GameObject + ComponentMenuPrefix_Root_Cursor_Behaviour_State;
