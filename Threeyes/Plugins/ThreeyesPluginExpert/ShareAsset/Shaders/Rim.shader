//Ref from: Lean/Common/Object
//功能：泛光
//目前应用Mod：IcoSphere AudioVisualizer
Shader "Threeyes/Common/Rim"
{
	Properties
	{
		_MainTex("Main Tex", 2D) = "white" {}
		[HDR]_Color("Color", Color) = (1.0, 1.0, 1.0, 1.0)
		[HDR]_Color1("Color 1", Color) = (1.0, 0.5, 0.5, 1.0)
		[HDR]_Color2("Color 2", Color) = (0.5, 0.5, 1.0, 1.0)
		_Rim("Rim", Float) = 1.0
