...
namespace Threeyes.Persistent
{
    ...
    public class PersistentAssetFilePathAttribute : Attribute
    {
        ...
        /// </summary>
        public static Action<object, FieldInfo, ExternalResources.LoadResult, object> AssetChanged;
        ...
        public object InvokeCallbackMethodInfo(FieldInfo fieldInfoAttribute, object obj, PersistentChangeState persistentChangeState)
        {
            ...
            try
            {
                if (IsAutoLoad)//自动加载资源
                {
                    ...
                    if (ExternalResources.CanLoad(fieldInfoAsset.FieldType))
                    {
                        ...
                        AssetChanged.Execute(obj, fieldInfoAsset, loadResult, objDefaultAsset);
                    }
                }
            }
            catch (Exception e)
        ...
        public static MethodInfo GetCallbackMethodInfo(FieldInfo fieldInfoAttribute)
        {
            ...
            MethodInfo methodInfo = objType.GetMethod(attribute.AssetLoadedCallbackMethodName, BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance);
    ...
    public class PersistentAssetChangedAttribute : FieldCallabackAttributeBase
    {
        ...
        public override MethodInfo GetCallbackMethodInfo(FieldInfo fieldInfoAttribute)
        {
            ...
            Type objType = fieldInfoAttribute.DeclaringType;
            MethodInfo methodInfo = objType.GetMethod(CallbackMethodName, BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance);
    ...
    public class PersistentChangedAttribute : Attribute
    {
        ...
        public static MethodInfo GetCallbackMethodInfo(Type objType)
        {
            ...
            MethodInfo methodInfo = objType.GetMethod(attribute.CallbackMethodName, BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance);
            if (methodInfo != null)
            {
                ParameterInfo[] arrParameterInfo = methodInfo.GetParameters();
