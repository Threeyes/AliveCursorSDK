...
namespace Threeyes.Persistent
{
    public abstract partial class PersistentDataBase : MonoBehaviour, IPersistentData, IHierarchyViewInfo
    {
        ...
        public abstract IDataOption BaseDataOption { get; }
    ...
    {
        public override IDataOption BaseDataOption { get { return new DataOption(); } }
    ...
    public abstract class PersistentDataBase<TValue, TEvent, TDataOption> : PersistentDataBase<TValue, TEvent>
        where TEvent : UnityEvent<TValue>
                where TDataOption : IDataOption
    {
        public override IDataOption BaseDataOption { get { return dataOption; } }
