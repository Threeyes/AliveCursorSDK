...
#pragma warning disable CS0618
            EditorVersionUpdateTool.TransferUnityEvent(this, ref onDestroy, ref onBeforeDestroy);
#pragma warning restore CS0618
    ...
    public class ElementBase<TManager, TElement, TData> : ElementBase<TData>, IElement<TManager>
       where TManager : class//不限制类型，方便设置为任意实例，以及方便SequenceElementBase等继承
        where TData : class
    {
        public TManager Manager { get { return manager; } set { manager = value; } }
        [SerializeField] protected TManager manager;
    }

    public interface IElement<TManager>
    {
