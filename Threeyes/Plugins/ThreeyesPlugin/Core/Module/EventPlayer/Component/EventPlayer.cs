...
namespace Threeyes.EventPlayer
{
    ...
    public class EventPlayer : MonoBehaviour, IHierarchyViewInfo
    {
        ...
        //——Debug Setting——
        public virtual bool IsPlayed { get { return isPlayed; } protected set { isPlayed = value; RepaintHierarchyWindow(); } }
        ...
        public virtual void SetHierarchyGUIProperty(StringBuilder sB)
        {
            ...
            //#SEP Setting
            {
                Sequence_EventPlayer eventPlayerSequence = transform.GetComponentInParent<Sequence_EventPlayer>();
                if (eventPlayerSequence)
                {
                    sbCache.Length = 0;
