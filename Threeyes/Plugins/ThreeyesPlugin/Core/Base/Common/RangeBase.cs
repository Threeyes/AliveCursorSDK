...
namespace Threeyes.Core
{
    ...
    {
        public override int RandomValue { get { return Random.Range(MinValue, MaxValue + 1); } }//PS: Random.Range Returns a random integer number between min [inclusive] and max [exclusive]，所以要+1
