...
namespace Threeyes.Core
{
    ...
    public abstract class SequenceAbstract : MonoBehaviour, ISequence, IHierarchyViewInfo
    {
        ...
        #region Obsolete
        [Obsolete("Use onBeforeSet Instead")] [HideInInspector] public IntEvent onBeforeSetData;//When the index of Data is begin to Init, the param is target index
        [Obsolete("Use onSet Instead")] [HideInInspector] public IntEvent onSetData;//When the index of Data has been Inited, the param is target index
#if UNITY_EDITOR
        void OnValidate()
        {
