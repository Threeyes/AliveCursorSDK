...
namespace Threeyes.ModuleHelper
{
    ...
    /// </summary>
    public class UIResizePanel : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
    {
        ...
        public BoolEvent onPointerDownUp;
        ...
        {
            originalPanelSize = panelRectTransform.GetSize();//Cache
            RectTransformUtility.ScreenPointToLocalPointInRectangle(panelRectTransform, data.position, data.pressEventCamera, out originalLocalPointerPosition);
            onPointerDownUp.Invoke(true);
        }
        public void OnPointerUp(PointerEventData eventData)
        {
            onPointerDownUp.Invoke(false);
        }
