...
/// 读写Ini文件
/// 
/// 修改：File.ReadAllText/WriteAllText增加了相应的Encoding，使其能够读写中文
/// </summary>
public class INIParser
{
    ...
    public void Open(string path)
    {
        ...
        {
            m_iniString = File.ReadAllText(m_FileName,Encoding.UTF8);
        }
        else
        {
    ...
    private void PerformFlush()
    {
        ...
        try
        {
            ...
            if (m_FileName != null)
            {
                File.WriteAllText(m_FileName, m_iniString,Encoding.UTF8);
            }
        }
        finally
        {
