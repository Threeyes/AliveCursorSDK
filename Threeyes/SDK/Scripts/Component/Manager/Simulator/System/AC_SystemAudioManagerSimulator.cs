...
public class AC_SystemAudioManagerSimulator : AC_SystemAudioManagerBase<AC_SystemAudioManagerSimulator>
{
	[Space]
	[InfoBox(
	...
	private void Update()
	{
		...
		m_AudioSource.GetOutputData(rawSampleData, 0);
		// fetch the fft
		m_AudioSource.GetSpectrumData(fftData, 0, FFTWindow.BlackmanHarris);
