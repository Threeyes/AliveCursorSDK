...
[AddComponentMenu(AC_EditorDefinition.ComponentMenuPrefix_Persistent + "AC_PersistentData_OptionSkin", 0)]
public class AC_PersistentData_OptionSkin : PersistentData_Option
{
    ...
    [UnityEditor.MenuItem(AC_EditorDefinition.HierarchyMenuPrefix_Persistent + "OptionPD_Skin", false)]
    public static void CreateInst_Skin()
    {
        Threeyes.Editor.EditorTool.CreateGameObjectAsChild<AC_PersistentData_OptionSkin>(instName_Skin);
    }
