...
/// </summary>
[CreateAssetMenu(menuName = AC_EditorDefinition.AssetMenuPrefix_AC_Cursor_Behaviour_Input + "ActionCollection", fileName = "CursorInputActionCollection", order = 0)]
public class AC_SOCursorInputActionCollection : AC_SOCollectionBase<AC_CursorInputType, SOActionBase>
{
    [Expandable]
