...
/// </summary>
public class AC_ViewBoundsFitter : MonoBehaviour
	, IAC_SystemWindow_ChangedHandler
{
	...
	{
		Camera mainCamera = AC_ManagerHolder.EnvironmentManager.MainCamera;
		float screenAspect = (float)Screen.width / Screen.height;
		float DistanceToCamera = (transform.position.z - mainCamera.transform.position.z);//与相机的距离

		float viewBoundsHeight = DistanceToCamera * Mathf.Tan(Mathf.Deg2Rad * mainCamera.fieldOfView / 2) * 2;//(距离×tanθ)*2
