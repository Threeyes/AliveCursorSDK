...
/// </summary>
public class AC_WhiteboardPen : InstanceBase<AC_WhiteboardPen>
{
	...
	private AC_Whiteboard whiteboard;
	private RaycastHit touch;
	ConfigInfo Config { get { return AC_Whiteboard.Instance.Config; } }
	...
	protected virtual void Update()
	{
		...
		if (IsDrawKeyDown())
		{
			...
			{
				whiteboard = touch.collider.GetComponent<AC_Whiteboard>();
