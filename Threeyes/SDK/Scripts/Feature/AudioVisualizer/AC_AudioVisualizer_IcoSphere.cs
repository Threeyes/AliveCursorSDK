    ...
    , IAC_ModHandler
{
    ...
    public IAC_SystemAudioManager Manager { get { return AC_ManagerHolder.SystemAudioManager; } }
    ...
    public void OnFFTDataChanged(float[] data)//Replace SpectrumData with FFTData to ignore volume
    {
    ...
    async void ReGenerateMesh()
    {
        ...
        m_Transform.localPosition = default(Vector3);//ResetPos
