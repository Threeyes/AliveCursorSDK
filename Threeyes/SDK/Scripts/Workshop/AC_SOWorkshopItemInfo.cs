...
public sealed class AC_SOWorkshopItemInfo : ScriptableObject
{
    ...
    public AC_WCItemVisibility ItemVisibility { get { return itemVisibility; } set { itemVisibility = value; } }//#4 可视性
    /// <summary>
    /// #5 Tags，用逗号分隔
    /// </summary>
    public string[] Tags
    ...
    [SerializeField] AC_WCItemVisibility itemVisibility = AC_WCItemVisibility.Public;

    public AC_WCItemAgeRatingType ageRatingType = AC_WCItemAgeRatingType.General;
    public AC_WCItemStyle itemStyle = AC_WCItemStyle.None;
    public AC_WCItemGenre itemGenre = AC_WCItemGenre.None;
    public AC_WCItemReference itemReference = AC_WCItemReference.None;
    public AC_WCItemFeature itemFeature = AC_WCItemFeature.None;

    [HideInInspector] public AC_WCItemSafety itemSafety = AC_WCItemSafety.None;
