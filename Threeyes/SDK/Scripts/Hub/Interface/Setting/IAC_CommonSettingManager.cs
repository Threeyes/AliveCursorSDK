...
/// 
/// ToDo:暴露所有设置
/// PS:以下字段不应提炼到基类接口中，因为每个程序暴露的设置不一样
/// </summary>
public interface IAC_CommonSettingManager : IHubManagerModInitHandler
{
	/// <summary>
...
/// <summary>
/// PS：
/// -Will be called on mod init or setting changed
/// </summary>
...
/// 
/// Warning:
/// -For common components, use IHubProgramActiveHandler instead
/// </summary>
