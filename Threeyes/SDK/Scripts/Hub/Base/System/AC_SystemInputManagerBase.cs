	...
	where T : AC_SystemInputManagerBase<T>
{
	...
	protected virtual void OnMouseMove(AC_MouseEventExtArgs e)
	{
		...
		EventCommunication.SendMessage<IAC_SystemInput_MouseMoveHandler>(inst => inst.OnMouseMove(e));
	}
	protected virtual void OnMouseDownUp(AC_MouseEventExtArgs e)
	{
		...
		UpdateMouseInputInfo();
		EventCommunication.SendMessage<IAC_SystemInput_MouseButtonHandler>(inst => inst.OnMouseButton(e));
	}
	protected virtual void OnMouseDragStartFinish(AC_MouseEventExtArgs e, bool isStart)
	{
		...
		if (isStart)
			...
			e.IsDragFinish = true;
		EventCommunication.SendMessage<IAC_SystemInput_MouseDragHandler>(inst => inst.OnMouseDrag(e));
	}
	protected virtual void OnMouseWheel(AC_MouseEventExtArgs e)
	{
		...
		EventCommunication.SendMessage<IAC_SystemInput_MouseWheelHandler>(inst => inst.OnMouseWheel(e));
	}
