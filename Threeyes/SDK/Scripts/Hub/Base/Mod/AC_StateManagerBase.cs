...
public class AC_StateManagerBase<T> : HubManagerWithControllerBase<T, IAC_StateController, AC_DefaultStateController>
    , IAC_StateManager
    ...
    where T : AC_StateManagerBase<T>
{
    ...
    void OnStateMachineStateChange(AC_CursorStateInfoEx cursorStateInfo)//Control Animator's State changed
    {
        ...
        EventCommunication.SendMessage<IAC_CursorState_ChangedHandler>((inst) => inst.OnCursorStateChanged(cursorStateInfo));
