...
/// </summary>
[AddComponentMenu(AC_EditorDefinition.ComponentMenuPrefix_Root_Cursor_Behaviour_Appearance + "AC_CursorAppearanceBehaviourCollection", 1)]
	...
	, IAC_SystemCursor_AppearanceChangedHandler
{
	...
	[UnityEditor.MenuItem(AC_EditorDefinition.HierarchyMenuPrefix_Root_Cursor_Behaviour_Appearance + "CursorAppearanceBehaviourCollection", false, 1)]
	public static void CreateInst()
	{
		Threeyes.Editor.EditorTool.CreateGameObjectAsChild<AC_CursorAppearanceBehaviourCollection>(instName);
	}
#endif
	#endregion
}