...
/// </summary>
[CreateAssetMenu(menuName = AC_EditorDefinition.AssetMenuPrefix_Root_Cursor_Behaviour_Appearance + "ActionCollection", fileName = "CursorAppearanceActionCollection", order = 0)]
