...
/// </summary>
[AddComponentMenu(AC_EditorDefinition.ComponentMenuPrefix_Root_Cursor_Controller + "AC_DefaultStateController")]
public class AC_DefaultStateController : AC_StateControllerBase<AC_SODefaultStateControllerConfig, AC_DefaultStateController.ConfigInfo>
{
	...
	public override bool IsCurStateActionComplete(ActionState actionState)
	{
		...
		return curSOAction.IsComplete(GoActionTarget, actionState);
	}
	...
	[UnityEditor.MenuItem(AC_EditorDefinition.HierarchyMenuPrefix_Root_Cursor_Controller_State + "Default", false)]
