...
/// </summary>
[CreateAssetMenu(menuName = AC_EditorDefinition.AssetMenuPrefix_Root_Mod_Behaviour_Appearance + "InfoCollection", fileName = "CursorAppearanceInfoCollection", order = 2)]
