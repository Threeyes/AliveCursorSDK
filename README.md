...
+ Merge the following snippet to `Packages/manifest.json` file in your project, or just download the latest [manifest.json](https://raw.githubusercontent.com/Threeyes/AliveCursorSDK/main/ProjectConfig~/manifest.json) file and replace it. (Make sure "com.threeyes.alivecursor.sdk": "*<u>X.X.X</u>" has point to the latest version):
```json
{
    "scopedRegistries": [
        {
    ...
    "dependencies": {
        ...
        "com.threeyes.alivecursor.sdk": "1.0.2",
...
+ Open Project, some error may appear on first import due to the , try cleanup or restart project.
## Documentation
Please hold...